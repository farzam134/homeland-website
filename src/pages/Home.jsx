    ...
    <>
      ...
      <section className='propertycard'>
        <div className="container mt-4">
          <div className="row">
            <PropertyCard image="/img_1.jpg" title="625 S. Berendo St" address="Los Angeles, CA 90005" price="$2,265,500" beds={2} baths={2} area="7,000" tag1="SALE" tag2="RENT" />
            <PropertyCard image="/img_2.jpg" title="871 Crenshaw Blvd" address="New York Ave, NY 2282" price="$2,265,500" beds={3} baths={2} area="1,620" tag1="SALE" tag2="RENT" />
            <PropertyCard image="/img_3.jpg" title="853 S Lucerne Blvd" address="Los Angeles, CA 90005" price="$2,265,500" beds={4} baths={3} area="5,500" tag1="LEASE" tag2="" />
            <PropertyCard image="/img_4.jpg" title="625 S. Berendo St" address="Los Angeles, CA 90005" price="$2,265,500" beds={2} baths={2} area="7,000" tag1="SALE" tag2="RENT" />
            <PropertyCard image="/img_5.jpg" title="871 Crenshaw Blvd" address="New York Ave, NY 2282" price="$2,265,500" beds={3} baths={2} area="1,620" tag1="SALE" tag2="RENT" />
            <PropertyCard image="/img_6.jpg" title="853 S Lucerne Blvd" address="Los Angeles, CA 90005" price="$2,265,500" beds={4} baths={3} area="5,500" tag1="LEASE" tag2="" />
          </div>
        </div>
